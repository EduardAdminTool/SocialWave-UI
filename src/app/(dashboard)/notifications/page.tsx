      ...
      <div className="flex items-center gap-4 p-2 w-[600px] justify-between">
        <div className="flex gap-4">
          <div className="relative w-12 h-12">
            <div className="absolute inset-0 flex justify-center items-center rounded-full bg-blue-600 w-10 h-10">
              <span className="text-white text-xl font-bold">-</span>
            </div>
            <div className="absolute inset-0 left-4 top-2 flex justify-center items-center rounded-full bg-green-500 w-10 h-10">
              <span className="text-white text-xl font-bold">+</span>
            </div>
          </div>
